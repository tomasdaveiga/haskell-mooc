...
member el (Set st) = el `elem` st

-- add a member to a set
add :: Ord a => a -> Set a -> Set a
add el (Set st) 
  | member el (Set st) = Set st
  | otherwise = Set (sort (el : st))
...
data Arithmetic = Operation String Arithmetic Arithmetic
  | Literal Integer
  deriving Show
...
operation op ar1 ar2 = Operation op ar1 ar2 

evaluate :: Arithmetic -> Integer
evaluate (Literal a) = a
evaluate (Operation "+" ar1 ar2) = evaluate ar1 + evaluate ar2
evaluate (Operation "-" ar1 ar2) = evaluate ar1 - evaluate ar2
evaluate (Operation "*" ar1 ar2) = evaluate ar1 * evaluate ar2

render :: Arithmetic -> String
render (Literal a) = show a
render (Operation "+" ar1 ar2) = "(" <> render ar1 <> "+" <> render ar2 <> ")"
render (Operation "-" ar1 ar2) = "(" <> render ar1 <> "-" <> render ar2 <> ")"
render (Operation "*" ar1 ar2) = "(" <> render ar1 <> "*" <> render ar2 <> ")"
